...
export interface ServerConfig {
  ...
  guestChatChannel: string;
  transcriptChannel: string;
  cwlSignupChannel: string;
  cwlRosterChannel: string;
  rankProposalChannel: string;
  familyLeadChannel: string;
  adminRole: string;
...
configMap.set('1021786969077973022', {
  ...
  generalChannel: '1021786969077973025',
  announcementChannel: '1280915536976281672',
  appApprovalChannel: '1367868025440833576',
  ...
  guestChatChannel: '1279032545413038100',
  transcriptChannel: '1377717816823644271',
  cwlSignupChannel: '1391983800757518550',
  cwlRosterChannel: '1383649776284860488',
  rankProposalChannel: '1422404233818275860',
  familyLeadChannel: '1424834072760291489',
...
configMap.set('1111490767991615518', {
  ...
  generalChannel: '1111490768436199565',
  announcementChannel: '1274985481842589758',
  appApprovalChannel: '1369675072364740679',
  ...
  guestChatChannel: '1112859424193777814',
  transcriptChannel: '1179098134975107173',
  cwlSignupChannel: '1155987285184106626',
  cwlRosterChannel: '1377795905612152924',
  rankProposalChannel: '1424861717011235010',
  familyLeadChannel: '1276364688288124949',
